...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const initComponentOptions = () => {
        ...
        demoSelects.forEach((select) => { select.options = standardOptions; });
        // Tabs
        const tabItems = [
        ...
        demoTabs.forEach((tabs) => { tabs.items = tabItems; });
        // Menus
        const menuOptions = [
    ...
    if (paletteSelector) {
        ...
        paletteSelector.addEventListener('change', (e) => {
            ...
            switch (val) {
                case 'sapphire':
                    rootTheme.config = THEME_SAPPHIRE;
                    break;
                case 'emerald':
                    rootTheme.config = THEME_EMERALD;
                    break;
                case 'cyber':
                    rootTheme.config = THEME_CYBER;
                    break;
                default:
    ...
    const setupGroup = (groupId, displayId) => {
    ...
    const initScifiSpecialty = () => {
        const scifiSelect = document.getElementById('scifi-select-levels');
        if (scifiSelect) {
            scifiSelect.options = [
        ...
        const scifiTabs = document.getElementById('scifi-tabs-main');
        if (scifiTabs) {
            scifiTabs.items = [
        ...
        const scifiDialog = document.getElementById('scifi-dialog');
