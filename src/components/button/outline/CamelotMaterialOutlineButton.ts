...
export class CamelotMaterialOutlineButton extends LitElement {
  ...
  static styles = css`
    ...
    /* Color Variants */
    .primary { color: var(--cml-color-primary); border-color: var(--cml-color-primary); }
    .secondary { color: var(--cml-color-secondary); border-color: var(--cml-color-secondary); }
    .tertiary { color: var(--cml-color-tertiary); border-color: var(--cml-color-tertiary); }
