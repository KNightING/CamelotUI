 ...
 */
let CamelotScifiConfirmDialog = class CamelotScifiConfirmDialog extends CamelotScifiBase {
    constructor() {
        super(...arguments);
        this.titleText = '';
        this.message = '';
...
], CamelotScifiConfirmDialog.prototype, "titleText", void 0);
__decorate([
    property({ type: String }),
    __metadata("design:type", Object)
], CamelotScifiConfirmDialog.prototype, "message", void 0);
__decorate([
    property({ type: String }),
    __metadata("design:type", Object)
], CamelotScifiConfirmDialog.prototype, "confirmText", void 0);
__decorate([
    property({ type: String }),
    __metadata("design:type", Object)
], CamelotScifiConfirmDialog.prototype, "cancelText", void 0);
__decorate([
    property({ type: Boolean, reflect: true }),
    __metadata("design:type", Object)
], CamelotScifiConfirmDialog.prototype, "open", void 0);
CamelotScifiConfirmDialog = __decorate([
    customElement('camelot-scifi-confirm-dialog-impl')
], CamelotScifiConfirmDialog);
export { CamelotScifiConfirmDialog };
//# sourceMappingURL=CamelotScifiConfirmDialog.js.map