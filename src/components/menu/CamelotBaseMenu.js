...
export class CamelotBaseMenu extends CamelotBaseElement {
    ...
    _findActivePath(options, targetKey, path) {
    ...
    renderItem(option, level) {
      ...
      <div 
        class="menu-item"
        @click="${(e) => !isAccordion && (hasChildren ? this._toggleExpand(option.key, e) : this._handleSelect(option.key, e))}"
      >
    ...
    `;
        ...
        >
          <camelot-expand 
            .expanded="${isExpanded}" 
            @toggle="${(e) => this._toggleExpand(option.key, e)}"
          >
            ${itemContent}
    ...
    renderArrow(isExpanded, isRight = false) {
        if (isRight)
            return html `<span class="arrow">▶</span>`;
...
], CamelotBaseMenu.prototype, "options", void 0);
__decorate([
    property({ type: String, reflect: true }),
    __metadata("design:type", String)
], CamelotBaseMenu.prototype, "value", void 0);
__decorate([
    property({ type: Boolean, reflect: true }),
    __metadata("design:type", Object)
], CamelotBaseMenu.prototype, "collapsed", void 0);
__decorate([
    property({ type: String, reflect: true }),
    __metadata("design:type", String)
], CamelotBaseMenu.prototype, "mode", void 0);
__decorate([
    property({ type: Number }),
    __metadata("design:type", Object)
], CamelotBaseMenu.prototype, "indent", void 0);
__decorate([
    state(),
    __metadata("design:type", Set)
], CamelotBaseMenu.prototype, "_expandedKeys", void 0);
__decorate([
    state(),
    __metadata("design:type", Set)
], CamelotBaseMenu.prototype, "_activePathKeys", void 0);
//# sourceMappingURL=CamelotBaseMenu.js.map