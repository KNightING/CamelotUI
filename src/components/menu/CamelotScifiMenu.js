 ...
 */
let CamelotScifiMenu = class CamelotScifiMenu extends CamelotBaseMenu {
    static { this.styles = [
...
CamelotScifiMenu = __decorate([
    customElement('camelot-scifi-menu')
], CamelotScifiMenu);
export { CamelotScifiMenu };
//# sourceMappingURL=CamelotScifiMenu.js.map